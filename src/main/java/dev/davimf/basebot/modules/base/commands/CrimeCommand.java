...
/** /crime — ganho arriscado com chance de multa; exige arma equipada. */
public final class CrimeCommand implements SlashCommand {
    private final CrimeEconomyService crime;
    private final JailService jail;
    public CrimeCommand(CrimeEconomyService crime, JailService jail) {
        this.crime = crime;
        this.jail = jail;
    }

    @Override public String name() { return "crime"; }

    @Override public SlashCommandData data() {
        return Commands.slash("crime", "Cometa um crime — arriscado, mas pode render bem.");
    }
